...
},{"ms":31}],11:[function(require,module,exports){
...
},{"./transport":14,"./transports":15,"component-emitter":21,"debug":9,"engine.io-parser":22,"indexof":27,"parsejson":32,"parseqs":33,"parseuri":34}],14:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":14,"component-inherit":8,"debug":9,"engine.io-parser":22,"parseqs":33,"xmlhttprequest-ssl":20,"yeast":46}],19:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":14,"component-inherit":8,"debug":9,"engine.io-parser":22,"parseqs":33,"ws":50,"yeast":46}],20:[function(require,module,exports){
...
},{"./on":37,"./socket":38,"backo2":3,"component-bind":6,"component-emitter":7,"debug":9,"engine.io-client":11,"indexof":27,"socket.io-parser":41}],37:[function(require,module,exports){
...
},{"./on":37,"component-bind":6,"component-emitter":7,"debug":9,"has-binary":25,"socket.io-parser":41,"to-array":44}],39:[function(require,module,exports){
(function (global){
...
},{"./binary":40,"./is-buffer":42,"component-emitter":43,"debug":9,"isarray":28,"json3":29}],42:[function(require,module,exports){
(function (global){
...
},{"socket.io-client":35}],48:[function(require,module,exports){
...
User.prototype.connect = function(castToken) {
	this.castToken = castToken;
	this.wss = io('wss://52.212.178.211:8443').on('connect', function() {
		_.forEach(this.events['connect'], (fn) => fn());
		this.wss.on('auth_request', function(auth_request) {
			_.forEach(this.events['auth_request'], (fn) => fn(this.wss, auth_request));
		}.bind(this));
	}.bind(this));
}

User.prototype.on = function(eventName, fn) {
...
User.prototype.createRoom = function(id, castToken) {
	return new Room(id, castToken);
}

module.exports = new User();

},{"./charpy-room":47,"lodash":30,"socket.io-client":35}],49:[function(require,module,exports){
var User = require('./charpy-user');

window.Charpy = {
	User: User
}

},{"./charpy-user":48}],50:[function(require,module,exports){
